// github.com/comiccoin-network/monorepo/cloud/comiccoin-publicfaucet/interface/http/login/login.go
package handler
...
import (
	...
	service_login "github.com/comiccoin-network/monorepo/cloud/comiccoin-publicfaucet/service/login"
)
