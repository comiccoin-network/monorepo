// github.com/comiccoin-network/monorepo/cloud/comiccoin-publicfaucet/common/oauthclient/domain/remotefederatedidentity/model.go
package domain
...
type RemoteFederatedIdentityDTO struct {
