// github.com/comiccoin-network/monorepo/cloud/comiccoin-publicfaucet/common/oauthclient/domain/federatedidentity/model.go
package domain
...
type FederatedIdentity struct {
	...
	CreatedByFederatedIdentityID  primitive.ObjectID      `bson:"created_by_user_id" json:"created_by_user_id"`
	CreatedAt                 time.Time               `bson:"created_at" json:"created_at,omitempty"`
	CreatedByName             string                  `bson:"created_by_name" json:"created_by_name"`
	ModifiedFromIPAddress     string                  `bson:"modified_from_ip_address" json:"modified_from_ip_address"`
	ModifiedByFederatedIdentityID primitive.ObjectID      `bson:"modified_by_user_id" json:"modified_by_user_id"`
...
type FederatedIdentityFilterResult struct {
	FederatedIdentitys []*FederatedIdentity   `json:"users"`
