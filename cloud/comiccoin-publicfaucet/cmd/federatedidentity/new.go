// github.com/comiccoin-network/monorepo/cloud/comiccoin-publicfaucet/cmd/federatedidentity/new.go
...
import (
	...
	repo_federatedidentity "github.com/comiccoin-network/monorepo/cloud/comiccoin-publicfaucet/common/oauthclient/repo/federatedidentity"
...
func doRunCreateFederatedIdentity() {
	...
	federatedidentityRepo := repo_federatedidentity.NewRepository(oauthClientConfig, logger, dbClient)
	federatedidentityCreateUseCase := uc_federatedidentity.NewFederatedIdentityCreateUseCase(oauthClientConfig, logger, federatedidentityRepo)
