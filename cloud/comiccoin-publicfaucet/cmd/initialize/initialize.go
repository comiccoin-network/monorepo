...
import (
	...
	sv_publicfaucet "github.com/comiccoin-network/monorepo/cloud/comiccoin-publicfaucet/service/gateway"
...
func doRunPublicFaucetInit() {
	...
	initService := sv_publicfaucet.NewPublicFaucetInitService(
		cfg,
		logger,
		passp,
