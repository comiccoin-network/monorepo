// github.com/comiccoin-network/monorepo/cloud/comiccoin/cmd/gateway/initialize/initialize.go
package initialize
...
import (
	...
	passwordp "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/common/security/password"
	...
	repo_federatedidentity "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/gateway/repo/federatedidentity"
	sv_gateway "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/gateway/service/gateway"
...
func doRunGatewayInit() {
	...
	cfg := &config.Configuration{
		DB: config.DBConfig{
			URI:         getEnv("COMICCOIN_DB_URI", true),
			GatewayName: getEnv("COMICCOIN_DB_GATEWAY_NAME", true),
		},
	}
