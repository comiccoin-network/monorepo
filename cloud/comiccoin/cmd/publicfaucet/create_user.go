...
// Usage:
// go run main.go publicfaucet create-user --email=user@example.com --password=password123 --password-confirm=password123 --first-name=John --last-name=Doe --phone="+12345678901" --country="United States" --timezone="America/New_York" --agree-terms=true
...
func doRunCreateUser() {
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		newUser := &user.User{
			...
			WasEmailVerified:        true,        // Developers note: If we run this CLI, we assume this email was verified.
