// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/common/oauthclient/domain/model.go
package oauth
...
type IntrospectionResponse struct {
	...
	Identityname        string `json:"username,omitempty"`  // Username of the resource owner
