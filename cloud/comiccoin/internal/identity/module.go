...
import (
	...
	"github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http"
	httpserver "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http"
	...
	httpmiddle "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/middleware"
	"github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/task"
	r_banip "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/repo/bannedipaddress"
	"github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/repo/templatedemailer"
	r_user "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/repo/user"
	sv_dashboard "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/service/dashboard"
	svc_gateway "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/service/gateway"
	svc_hello "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/service/hello"
	svc_me "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/service/me"
	uc_bannedipaddress "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/usecase/bannedipaddress"
	uc_emailer "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/usecase/emailer"
...
func NewModule(
	...
	mongodbCacheConfigurationProvider := mongodb_cache.NewCacheConfigurationProvider(cfg.DB.IdentityName)
	...
	mailgunConfigurationProvider := mailgun.NewMailgunConfigurationProvider(
		cfg.IdentityEmailer.SenderEmail,
		cfg.IdentityEmailer.Domain,
		cfg.IdentityEmailer.APIBase,
		cfg.IdentityEmailer.MaintenanceEmail,
		cfg.IdentityEmailer.FrontendDomain,
		cfg.IdentityEmailer.BackendDomain,
		cfg.IdentityEmailer.APIKey,
	)
...
func (s *IdentityModule) GetHTTPServerInstance() httpserver.HTTPServer {
	return s.httpServer
}

func (s *IdentityModule) GetTaskManagerInstance() task.TaskManager {
