// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/http.go
package http
...
import (
	...
	// http_introspection "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/introspection"
	// http_login "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/login"
	mid "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/middleware"
	http_system "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/system"

	// http_oauth "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/oauth"
	// http_registration "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/registration"
	// http_token "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/token"
	http_dashboard "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/dashboard"
	http_gateway "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/gateway"
	http_hello "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/hello"
	http_me "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/me"
)
...
func (port *httpServerImpl) HandleIncomingHTTPRequest(w http.ResponseWriter, r *http.Request) {
	...
	handler := port.middleware.Attach(func(w http.ResponseWriter, r *http.Request) {
		...
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "register" && r.Method == http.MethodPost:
			port.gatewayUserRegisterHTTPHandler.Execute(w, r)
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "verify-email-code" && r.Method == http.MethodPost:
			port.gatewayVerifyEmailHTTPHandler.Execute(w, r)
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "verify" && r.Method == http.MethodPost: // DEPRECATED: Use verify-email-code instead
			port.gatewayVerifyEmailHTTPHandler.Execute(w, r)
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "login" && r.Method == http.MethodPost:
			port.gatewayLoginHTTPHandler.Execute(w, r)
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "logout" && r.Method == http.MethodPost:
			port.gatewayLogoutHTTPHandler.Execute(w, r)
		case n == 5 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "token" && p[4] == "refresh" && r.Method == http.MethodPost:
			port.gatewayRefreshTokenHTTPHandler.Execute(w, r)
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "forgot-password" && r.Method == http.MethodPost:
			port.gatewayForgotPasswordHTTPHandler.Execute(w, r)
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "reset-password" && r.Method == http.MethodPost:
			port.gatewayResetPasswordHTTPHandler.Execute(w, r)

		// --- Resource endpoints ---
		// Hello
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "say-hello" && r.Method == http.MethodPost:
			port.getHelloHTTPHandler.Execute(w, r)

		// Me
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "me" && r.Method == http.MethodGet:
			port.getMeHTTPHandler.Execute(w, r)
		case n == 5 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "me" && p[4] == "connect-wallet" && r.Method == http.MethodPost:
			port.postMeConnectWalletHTTPHandler.Execute(w, r)
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "me" && r.Method == http.MethodPut:
			port.putUpdateMeHTTPHandler.Execute(w, r)
		case n == 5 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "me" && p[4] == "delete" && r.Method == http.MethodPost:
			port.deleteMeHTTPHandler.Execute(w, r)

		// Dashboard
		case n == 4 && p[0] == "identity" && p[1] == "api" && p[2] == "v1" && p[3] == "dashboard" && r.Method == http.MethodGet:
