...
func (h *GatewayLoginHTTPHandler) unmarshalLoginRequest(
	...
	h.logger.Debug("beginning to decode json payload for api request ...", slog.String("api", "/publicidentity/api/v1/login"))
	...
	h.logger.Debug("successfully decoded json payload api request", slog.String("api", "/publicidentity/api/v1/login"))
