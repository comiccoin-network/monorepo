// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/dashboard/dashboard.go
package dashboard
...
import (
	...
	svc_dashboard "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/service/dashboard"
)
...
func (h *DashboardHTTPHandler) Execute(w http.ResponseWriter, r *http.Request) {
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		if err != nil {
			h.logger.Error("failed to get identity by chain id",
				slog.Any("error", err))
			return nil, err
		}
		return response, nil
