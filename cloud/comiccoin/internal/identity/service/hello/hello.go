// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/service/hello/service.go
package hello
...
func (s *helloServiceImpl) SayHello(ctx context.Context) (*HelloResponse, error) {
	...
	// // - github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/interface/http/middleware/auth.go
