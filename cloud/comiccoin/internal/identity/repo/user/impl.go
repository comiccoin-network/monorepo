// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/repo/user/impl.go
package user
...
import (
	...
	dom_user "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/domain/user"
)
...
func NewRepository(appCfg *config.Configuration, loggerp *slog.Logger, client *mongo.Client) dom_user.Repository {
	...
	uc := client.Database(appCfg.DB.IdentityName).Collection("users")
