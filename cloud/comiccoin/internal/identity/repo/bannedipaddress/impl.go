...
import (
	...
	dom_banip "github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/identity/domain/bannedipaddress"
)
...
func NewRepository(appCfg *config.Configuration, loggerp *slog.Logger, client *mongo.Client) dom_banip.Repository {
	...
	uc := client.Database(appCfg.DB.IdentityName).Collection("banned_ip_addresses")
