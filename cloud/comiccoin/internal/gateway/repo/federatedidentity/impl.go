// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/gateway/repo/federatedidentity/impl.go
...
func NewRepository(appCfg *config.Configuration, loggerp *slog.Logger, client *mongo.Client) dom_federatedidentity.Repository {
	...
	uc := client.Database(appCfg.DB.GatewayName).Collection("federated_identities")
