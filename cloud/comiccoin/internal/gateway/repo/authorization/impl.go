// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/gateway/repo/authorization/impl.go
...
func NewRepository(appCfg *config.Configuration, loggerp *slog.Logger, client *mongo.Client) dom_auth.Repository {
	...
	ac := client.Database(appCfg.DB.GatewayName).Collection("authorization_codes")
