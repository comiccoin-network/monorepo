// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/gateway/repo/application/impl.go
package application
...
func NewRepository(appCfg *config.Configuration, loggerp *slog.Logger, client *mongo.Client) dom_app.Repository {
	...
	ac := client.Database(appCfg.DB.GatewayName).Collection("applications")
