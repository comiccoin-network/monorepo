...
func (s *NameServiceModule) GetHTTPServerInstance() httpserver.HTTPServer {
	return s.httpServer
}

func (s *NameServiceModule) GetTaskManagerInstance() task.TaskManager {
