// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/nameservice/service/faucet/getbychainid.go
package faucet
...
func (svc *getFaucetServiceImpl) ExecuteByChainID(sessCtx mongo.SessionContext, chainID uint16) (*FaucetDTO, error) {
	...
	return &FaucetDTO{
		...
		DailyCoinsReward:           svc.config.Blockchain.NameServiceClaimCoinsReward,
	}, nil
}
