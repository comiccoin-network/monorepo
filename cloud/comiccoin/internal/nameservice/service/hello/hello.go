// github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/nameservice/service/hello/service.go
package hello
...
func (s *helloServiceImpl) SayHello(ctx context.Context) (*HelloResponse, error) {
	...
	// // - github.com/comiccoin-network/monorepo/cloud/comiccoin/internal/nameservice/interface/http/middleware/auth.go
