module github.com/comiccoin-network/monorepo/cloud/comiccoin-gateway
...
require (
	...
	github.com/comiccoin-network/monorepo/cloud/comiccoin-authority v0.0.0-20250206062207-8b29fb869b65
