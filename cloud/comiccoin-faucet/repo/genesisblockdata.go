...
func NewGenesisBlockDataRepository(cfg *config.Configuration, logger *slog.Logger, client *mongo.Client) domain.GenesisBlockDataRepository {
...
func (r *GenesisBlockDataRepo) OpenTransaction() error {
	defer log.Fatal("Unsupported feature in the `comiccoin-faucet` repository.")
	return nil
}
...
func (r *GenesisBlockDataRepo) DiscardTransaction() {
	log.Fatal("Unsupported feature in the `comiccoin-faucet` repository.")
}
