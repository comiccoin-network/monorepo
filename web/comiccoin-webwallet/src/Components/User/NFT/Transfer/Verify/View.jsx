...
const TransferNFTVerifyTransactionPage = () => {
    ...
    const expectedTokenID = parseInt(searchParams.get('token_id') || '0')
    const expectedTokenMetadataUri = searchParams.get('token_metadata_uri')
    ...
    const handleTransactionUpdate = useCallback(
        (transactionData) => {
            ...
            if (
                ...
                transactionData.type === 'token' &&
                parseInt(transactionData.value) === expectedTokenID
            ) {
            ...
            <div className="bg-white border-b">
                <div className="max-w-md mx-auto px-4 py-4">
                    ...
                    >
                        ...
                        <span className="text-base font-medium">Back to NFTs</span>
                    </button>
                </div>
            </div>
        ...
        <div className="flex-grow flex flex-col">
            ...
            <div className="bg-white border-b">
                <div className="max-w-md mx-auto px-4 py-4">
                    <button
                        onClick={() =>
                            navigate(`/nft?token_id=${expectedTokenID}&token_metadata_uri=${expectedTokenMetadataUri}`)
                        }
                        className="flex items-center text-purple-600 hover:text-purple-700 transition-colors"
                    >
                        <ArrowLeft className="w-5 h-5 mr-2" />
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="w-full space-y-3">
                            <button
                                onClick={() =>
                                    navigate(
                                        `/nft?token_id=${expectedTokenID}&token_metadata_uri=${expectedTokenMetadataUri}`
                                    )
                                }
