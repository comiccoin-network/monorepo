    ...
    <div className="group">
      ...
      >
        ...
        <div className="p-4 md:p-6">
          <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 line-clamp-1" style={{ fontFamily: 'Comic Sans MS' }}>
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-purple-100 to-white">
      ...
      <div className="flex-grow flex flex-col pt-6 pb-24 md:py-12">
        ...
        <div className="px-4 md:px-6 lg:px-12 w-full max-w-[1200px] mx-auto">
          <h1 className="text-2xl md:text-4xl font-bold text-purple-800 mb-2" style={{ fontFamily: 'Comic Sans MS' }}>
            My NFT Collection
          </h1>
          ...
          <div className="bg-white rounded-xl border border-gray-100">
            <div className="flex flex-col md:flex-row md:items-center justify-between p-4 md:p-6 border-b border-gray-100 gap-4 md:gap-0">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <span className="text-sm md:text-base text-gray-500">({filteredNFTs.length} total)</span>
              </div>
