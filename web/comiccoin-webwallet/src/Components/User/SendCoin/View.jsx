          ...
          <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-4 md:space-y-6" autoComplete="off">
            <div>
              <label htmlFor="recipientAddress" className="block">
                ...
                <input
                  ...
                  className={`mt-2 block w-full px-3 md:px-4 py-3 bg-white border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors text-base md:text-lg font-medium text-red-600">- {formData.amount} CC</p>
                </div>
                ...
                <div className="pt-2 border-t">
                  ...
                  <p className="text-base md:text-lg font-bold text-red-600">- {(parseFloat(formData.amount) + 1).toFixed(2)} CC</p>
                </div>
              ...
              {formData.note && (
                <div>
                  ...
                  <p className="text-base md:text-lg font-medium text-gray-900">{formData.note}</p>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-4">
              <button
                ...
                className="w-full py-4 md:py-3 px-4 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors text-base md:text-lg active:bg-gray-100 touch-manipulation"
              ...
              <button
                ...
                className="w-full py-4 md:py-3 px-4 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50 text-base md:text-lg active:bg-purple-800 touch-manipulation"
                disabled={isSubmitting}
              >
                {isSubmitting ? (
            ...
            <div>
              <label htmlFor="amount" className="block">
                ...
                <input
                  ...
                  className={`block w-full px-3 md:px-4 py-3 bg-white border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors text-base md:text-lg ${
            ...
            <div>
              <label htmlFor="password" className="block">
                ...
                <p className="mt-2 text-xs md:text-sm text-gray-600 flex items-start gap-2">
                  ...
                  <span>
                    Your wallet is encrypted and stored locally. Password required for authorization.
                  </span>
                </p>
              </label>
            </div>
