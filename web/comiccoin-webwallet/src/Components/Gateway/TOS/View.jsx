      ...
      <div class="container">
        <section class="section">
          ...
          <div class="content">
            ...
            <h2 class="title is-2">For Cards:</h2>
            <p>
              Collectible Protection Services is currently only grading regular
              sized trading cards (2.5×3.5 inches) ranging from 35pt to 180pt;
              any oversized cards such as booklets or cards exceeding the
              thickness of 180pt cannot be graded at this time and sports card
              submissions are not currently accepted. Cards must be sent in
              protective holders (i.e., top loaders, penny sleeves, one touches,
              etc.) when being shipped.
            </p>
            <h2 class="title is-2">For Comics:</h2>
            <p>
              Collectible Protection Services is currently only grading regular
              sized comic books (US sized, silver age onwards, 64 pages or
              less); any oversized comic books exceeding these characteristics
              cannot be graded at this time. Comic books must be sent in
              protective holders (i.e., top loaders, bag and board, etc.) when
              being shipped.{" "}
            </p>
            <p>
              Collectible Protection Services will not be held responsible for
              any damages incurred through the mail. Any supplies used to ship
              the items to Collectible Protection Services will not be returned.
            </p>
            <p>
              Collectible Protection Services will accept slabbed cards,
              however, while we will ensure to take every precaution when
              opening the case to avoid potential damage, we will not accept any
              responsibility should damage occur.{" "}
            </p>
            <p>All grades are determined by our grading team and are final.</p>
            <p>
              The Service Type selected will commence the day after the item has
              been received at our office (not when delivered to our address or
              when cards are dropped off/shipped to our retail partners). Any
              general service delays will be posted on our website.
            </p>
            <p>
              Service Type is calculated in BUSINESS DAYS. Monday-Friday (minus
              Statutory holidays) are considered business days and will be
              counted towards the Service Type selected.
            </p>
            <p>
              For any orders exceeding 75 items please email or call to verify
              Service Type availability. Failure to contact us prior to shipping
              your order will result in delays to your Service Type selected.
            </p>
            <p>
              Collectible Protection Services will primarily use UPS, but may
              use a similar carrier at its discretion. Large orders exceeding
              66lbs may incur additional shipping charges not covered by our
              flat rates.{" "}
            </p>
            <p>
              All shipments must include copies of the submission form(s) for
              the item in the same package with the order.{" "}
            </p>
            <p>
              Please correct any errors made in the process of filling out the
              Collectible Protection Services Submission Form with a single line
              through the error and initials above. Failure to neatly and
              accurately complete the Collectible Protection Services Submission
              Form can result in delays on the service turnaround time selected.
              Collectible Protection Services will contact the customer via
              phone or email using the contact information provided to clarify
              any issues and the service selected will not commence until the
              issues have been resolved. If there are any questions regarding
              the form, please contact us through email at info@cpscapsule.com
            </p>
            <p>
              Any discrepancies between this submission form and the items
              received will be followed up with a phone call or email using the
              contact information provided. The package as whole will not be
              graded and the service time will not commence until the customer
              has responded to COMICCOIN_FAUCET and the issue has been resolved. If a
              discrepancy occurs and cannot be resolved, your items will be
              returned, ungraded.{" "}
            </p>
            <p>
              COMICCOIN_FAUCET accepts no responsibility for items lost or damaged by
              carriers. Return shipping includes a maximum value of $100. You
              may purchase additional insurance coverage at an extra cost. In
              all cases, any claims of loss, regardless of how they occur,
              should be addressed to the carrier. You agree to hold harmless COMICCOIN_FAUCET
              and its partners for any damage or loss, however incurred.
            </p>
            <p>
              Please contact COMICCOIN_FAUCET for additional costs that may be incurred for
              items with a signature.
            </p>
            <p>
              Collectible Protection Services does not authenticate any items.
              Any items where the grader determines that there are clear signs
              of tampering/trimming, counterfeiting/unauthorized reprints or
              altering of any kind beyond professional restoration will be
              returned ungraded with the full fee still being charged.
            </p>
            <p>
              We currently accept Visa, MasterCard and PayPal as our online
              methods of payment. Service time will not commence until payment
              has been received in full.
            </p>
            <p>
              The declared value given by the customer will be used for
              informational purposes only and to determine the additional
              shipping insurance rate required. Those who elect not to insure up
              to the full declared value may only receive the insured amount
              covered for any lost or damaged packages/slabs. Any determination
              of value for lost or damaged packages is at the sole discretion of
              the carrier and not the responsibility nor under the control of
              COMICCOIN_FAUCET.
            </p>
            <p>
              Collectible Protection Services uses the utmost care to complete
              the grading process. Any disputes may only be applied to
              typographical label errors. COMICCOIN_FAUCET will allow up to 2 weeks after
              receiving the package to ensure the customer has reviewed their
              order. If there are any issues, please email COMICCOIN_FAUCET at
              info@cpscapsule.com
            </p>
            <h2 class="title is-2">FOR AUTHORIZED DEALERS:</h2>
            <p>
              By using this service, you agree to allow COMICCOIN_FAUCET to use
              non-personally identifying data from your submissions (including
              but not limited to videos and photographs of your items) royalty
              free, in perpetuity, worldwide, for the purposes of marketing its
              services. You also agree that your submissions will be included in
              the COMICCOIN_FAUCET registry with personally identifying information removed.
              You agree to hold COMICCOIN_FAUCET harmless for any typographical errors in the
              registry, submissions or in its promotional materials.
            </p>
            <p>
              Collectible Protection Services is not liable whatsoever for any
              damage caused to the items received, when not in the care or
              control of Collectible Protection Services
            </p>
            <p>
              In all cases, you agree that your sole remedy with COMICCOIN_FAUCET, regardless
              of any damages or losses however incurred, will be arbitration
              subject to the laws and jurisdiction of the Province of Ontario,
              and aggregated damages will be limited to submission fees.
            </p>
            <p>All shipments MUST be mailed to the following address: </p>
            <article class="message pb-3" style={{ width: "300px" }}>
              <div class="message-body">
                <p class="">
                  <b>COMICCOIN_FAUCET – Collectible Protection Services</b>
                </p>
                <p class="">8-611 Wonderland Road North, P.M.B. 125</p>
                <p class="">London, Ontario</p>
                <p class="">N6H1T6</p>
                <p class="">Canada</p>
                <p class="">
                ...
                <p class="">
                  <a href="mailto:info@cpscapsule.com">info@cpscapsule.com</a>
                </p>
              </div>
            </article>
            <p>
              By using this service and its related websites and apps, you agree
              to be bound by the most recent version of these Terms and
              conditions.
            </p>

            <h2 class="title is-2">E-Commerce Terms and Conditions:</h2>

            <h3 class="title is-3">OVERVIEW</h3>
            <p>
              This website is operated by Collectible Protection Services (or
              “COMICCOIN_FAUCET”). Throughout the site, the terms “we”, “us” and “our” refer
              to COMICCOIN_FAUCET. We offer this website, including all information, tools
            ...
            <p>
              ...
              at least the age of majority in your jurisdiction of residence, or
              that you are the age of majority in your jurisdiction of residence
            ...
            <p>
              ...
              destructive nature, attempt to penetrate our systems, or to steal
              or transmit any confidential data.
            </p>
            <p>
            ...
            <p>
              https://cpsapp.ca , https://cpscapsule.com and related sites are
              E-commerce Sites Our websites allow consumers and authorized
              retailers to purchase collectible grading and preservation
              services, as well as related items and services.{" "}
            </p>
            <h3 class="title is-3">Privacy</h3>
            <p>
              Your use of any COMICCOIN_FAUCET website is subject to our Privacy Policy.
              Please review our Privacy Policy, which also governs the Site and
              informs users of our data collection practices.
            </p>
            <h3 class="title is-3">Electronic Communications</h3>
            <p>
              Visiting this website or sending emails to us constitutes
            ...
            <h3 class="title is-3">Your account</h3>
            <p>
              ...
              person or entity. You acknowledge that we are not responsible for
              third party access to your account that results from theft or
              misappropriation of your account. COMICCOIN_FAUCET and its associates reserve
              the right to refuse or cancel service, terminate accounts, or
              remove or edit content in our sole discretion.
            </p>
            <p>
              We do not knowingly collect, either online or offline, personal
              information from persons under the age of thirteen. This site is
            ...
            <h3 class="title is-3">Cancellation/Refund Policy</h3>
            <p>
              Please note that WE DO NOT OFFER ANY REFUNDS. Please contact
              info@cpscapsule.com with any questions.
            </p>
            <h3 class="title is-3">
            ...
            <p>
              ...
              The Linked Sites are not under our control and we are not
              ...
              updates to a Linked Site. We are providing these links to you only
              as a convenience, and the inclusion of any link does not imply
              endorsement by us of the site or any association with its
              operators. It is your responsibility to review the Terms of Use,
              Privacy and other Policies of any Linked Sites.
            </p>
            <p>
              ...
              or functionality originating from this website, you hereby
              acknowledge and consent that we may share such information and
              data with any third party with whom we have a contractual
              relationship to provide the requested product, service or
              functionality on behalf of COMICCOIN_FAUCET users and customers.
            </p>
            <h3 class="title is-3">SECTION 2 – GENERAL CONDITIONS</h3>
            <p>
            ...
            <p>
              ...
              quantities and we do not offer refunds under any circumstances.
              All sales are considered to be complete and final.
            </p>
            <p>
            ...
            <h3 class="title is-3">SECTION 7 – OPTIONAL TOOLS</h3>
            <p>
            ...
            <h3 class="title is-3">SECTION 8 – THIRD-PARTY LINKS</h3>
            <p>
            ...
            <h3 class="title is-3">SECTION 12 – PROHIBITED USES</h3>
            <p>
            ...
            <p>
              In no case shall COMICCOIN_FAUCET, our directors, officers, employees,
              ...
              advised of their possibility, including data breach. Because some
              states or jurisdictions do not allow the exclusion or the
              limitation of liability for consequential or incidental damages,
              in such states or jurisdictions, our aggregated, total, lifetime
              and final liability shall be limited to $250.00 or the purchase
              value of your most recent order – whichever is lowest. In all
              cases, you agree that your sole remedy will be arbitration within
              the jurisdiction of Ontario, and subject to this agreement.
            </p>
            <h3 class="title is-3">SECTION 14 – INDEMNIFICATION</h3>
            <p>
              You agree to indemnify, defend and hold harmless COMICCOIN_FAUCET and our
            ...
            <h3 class="title is-3">SECTION 15 – SEVERABILITY</h3>
            <p>
            ...
            <h3 class="title is-3">SECTION 16 – TERMINATION</h3>
            <p>
            ...
            <h3 class="title is-3">SECTION 17 – ENTIRE AGREEMENT</h3>
            <p>
            ...
            <h3 class="title is-3">SECTION 18 – GOVERNING LAW</h3>
            <p>
              These Terms of Service and any separate agreements whereby we
              provide you Services shall be governed by and construed in
              accordance with the laws of the Province of Ontario.
            </p>
            <h3 class="title is-3">SECTION 19 – CHANGES TO TERMS OF SERVICE</h3>
            <p>
            ...
            <h3 class="title is-3">SECTION 20 – CONTACT INFORMATION</h3>
            <p>
