        ...
        <div className="min-h-screen flex flex-col bg-gradient-to-b from-purple-100 to-white">
            ...
            <main id="main-content" className="flex-grow w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 max-w-xl">
                ...
                <div className="text-center mb-6 sm:mb-12">
                    <h1
                        className="text-4xl sm:text-5xl md:text-6xl font-bold text-purple-800 mb-3"
                                            ...
                                            <div className="flex gap-3 sm:gap-4">
                                                ...
                                                <div className="text-xs sm:text-sm text-amber-800">
                                                    <p className="mb-2 sm:mb-3">
                                                        Important information about your recovery phrase:
                                                    </p>
                                                    <ul className="list-disc pl-4 space-y-0.5 sm:space-y-1">
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="mt-2 text-xs sm:text-sm text-yellow-700">
                                                        <p>
                                                            This is your only chance to save these words. They cannot be
                                                            recovered if lost!
                                                        </p>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs sm:text-sm text-amber-700">
                                            Please enter the requested words from your recovery phrase to verify you've
                                            saved it correctly.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    {verificationWords.map(({ position, word }) => (
                                        <div key={position}>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    handleVerificationInputChange(position - 1, e.target.value)
                                                }
