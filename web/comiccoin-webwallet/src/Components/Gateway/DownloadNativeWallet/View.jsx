...
import { Wallet, Monitor, Globe, ArrowRight, Shield, Github, CheckCircle, Apple, Terminal, Download } from 'lucide-react';
            ...
            <div className="bg-gradient-to-b from-indigo-600 to-indigo-500 text-white py-8 sm:py-12 md:py-16 mb-6 sm:mb-8 md:mb-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6" style={{fontFamily: 'Comic Sans MS'}}>
                        ...
                        <div className="p-4 sm:p-6 md:p-8">
                            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base text-purple-600">Available on Microsoft Store</p>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 sm:space-y-3">
                                        <li className="flex items-start gap-2">
                                            ...
                                            <span className="text-sm sm:text-base text-gray-600">Full blockchain node support</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mt-0.5 shrink-0" />
                                            <span className="text-sm sm:text-base text-gray-600">Automatic updates via Microsoft Store</span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div className="p-4 sm:p-6 md:p-8">
                            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base text-purple-600">Universal Binary (Intel/Apple Silicon)</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
                                <div>
                                    ...
                                    <ul className="space-y-2 sm:space-y-3">
                                        <li className="flex items-start gap-2">
                                            <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mt-0.5 shrink-0" />
                                            <span className="text-sm sm:text-base text-gray-600">Native Apple Silicon support</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mt-0.5 shrink-0" />
                                            <span className="text-sm sm:text-base text-gray-600">Optimized for macOS performance</span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="md:col-span-2 bg-white rounded-xl sm:rounded-2xl shadow-md sm:shadow-xl overflow-hidden border-2 border-purple-100">
                        <div className="p-4 sm:p-6 md:p-8">
                            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                                ...
                                <div>
                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Linux Installation</h2>
                                    <p className="text-sm sm:text-base text-purple-600">Available for Ubuntu/Debian and Fedora/RHEL systems</p>
                                </div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-start gap-2 bg-blue-50 p-3 rounded-lg">
                                        <Shield className="h-4 w-4 text-blue-600 mt-0.5 shrink-0" />
                                        <p className="text-xs text-blue-700">
                                            Supported on Fedora 37+ and RHEL 9+
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-3xl mx-auto mb-6 sm:mb-8 md:mb-12 px-4 sm:px-0">
                    ...
                    <div className="bg-white rounded-xl border-2 border-purple-100 p-4 sm:p-6">
                        <ul className="space-y-2 sm:space-y-3">
                            ...
                            <li className="flex items-start gap-2">
                                <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mt-0.5 shrink-0" />
                                <span className="text-sm sm:text-base text-gray-600">Enhanced security features</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mt-0.5 shrink-0" />
                                <span className="text-sm sm:text-base text-gray-600">Offline transaction signing</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mt-0.5 shrink-0" />
                                <span className="text-sm sm:text-base text-gray-600">4 GB RAM minimum (8 GB recommended)</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 mt-0.5 shrink-0" />
                                <span className="text-sm sm:text-base text-gray-600">1 GB available hard disk space</span>
                            </li>
                        </ul>
                    </div>
                </div>
