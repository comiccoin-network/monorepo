      ...
      <main id="main-content" className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg border-2 border-purple-100 p-8 mb-8">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Who we are</h2>
              <p className="text-gray-700">ComicCoin Network by Collectible Protection Services</p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Comments</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Media</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Cookies</h2>
              <div className="space-y-4 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Embedded content from other websites</h2>
              <div className="space-y-4 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Who we share your data with</h2>
              <p className="text-gray-700">If you request a password reset, your IP address will be included in the reset email.</p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">How long we retain your data</h2>
              <div className="space-y-4 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">What rights you have over your data</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Where we send your data</h2>
              <p className="text-gray-700">Visitor comments may be checked through an automated spam detection service.</p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Data Breach</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Disputes</h2>
              <p className="text-gray-700">You agree that your sole remedy for any disputes with us will be through arbitration, subject to the jurisdiction and laws of the State of Ontario. You also absolve us of any damages, no matter how they may occur. In the event that we are found liable, you agree that the maximum, aggregate, lifetime damages will not exceed $250.00 (two-hundred and fifty U.S. Dollars).</p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-purple-800 mb-3">Additional Questions</h2>
              <p className="text-gray-700">If you have any questions or need help ordering, simply email info@cpscapsule.com and we will be glad to assist.</p>
            </section>
          </div>
        </div>
