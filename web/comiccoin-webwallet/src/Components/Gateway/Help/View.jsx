...
function HelpPage() {
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-purple-100 to-white">
        ...
        <main id="main-content" className="flex-grow w-full mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 md:py-12 max-w-4xl">
            <Link
                to="/"
            ...
            <div className="bg-white rounded-lg sm:rounded-2xl shadow-sm sm:shadow-lg border border-purple-100 sm:border-2 p-3 sm:p-6 md:p-8 mb-3 sm:mb-8">
                ...
                <div className="space-y-4 sm:space-y-8 text-sm sm:text-base text-gray-700">
                    ...
                    <section className="scroll-mt-16" id="getting-started">
                        <h2 className="text-lg sm:text-2xl font-bold text-purple-800 mb-2 sm:mb-4">Getting Started</h2>
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-start gap-2 sm:gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-purple-700 text-sm sm:text-base">Access your wallet through any web browser. Perfect for quick access and convenience.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-2 sm:gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-purple-700 text-sm sm:text-base">Download our native app for Windows or MacOS for enhanced security and features.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="scroll-mt-16" id="creating-wallet">
                        <h2 className="text-lg sm:text-2xl font-bold text-purple-800 mb-2 sm:mb-4">Creating a Wallet</h2>
                        <div className="space-y-3 sm:space-y-4">
                    ...
                    <section className="scroll-mt-16" id="system-requirements">
                        <h2 className="text-lg sm:text-2xl font-bold text-purple-800 mb-2 sm:mb-4">System Requirements</h2>
                        <div className="space-y-3 sm:space-y-4">
                    ...
                    <section className="scroll-mt-16" id="features">
                        <h2 className="text-lg sm:text-2xl font-bold text-purple-800 mb-2 sm:mb-4">Features & Functions</h2>
                        <div className="bg-white rounded-lg border border-gray-200 p-3 sm:p-4">
                            <div className="space-y-3 sm:space-y-4">
                                <div>
                    ...
                    <section className="scroll-mt-16" id="troubleshooting">
                        <h2 className="text-lg sm:text-2xl font-bold text-purple-800 mb-2 sm:mb-4">Troubleshooting</h2>
                        <div className="space-y-3 sm:space-y-4">
                            <div className="bg-white rounded-lg border border-gray-200 p-3 sm:p-4">
                                ...
                                <div className="space-y-3 sm:space-y-4">
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm sm:text-base">Use your recovery phrase to restore access to your wallet and set a new password.</p>
                                    </div>
                                    <div>
                                        <p className="font-medium mb-1">Connection Issues</p>
                                        <p className="text-gray-600 text-sm sm:text-base">Ensure you have a stable internet connection and try refreshing your browser or restarting the desktop app.</p>
                                    </div>
                                    <div>
                                        <p className="font-medium mb-1">Sync Problems</p>
                                        <p className="text-gray-600 text-sm sm:text-base">If your wallet isn't syncing, try clearing your cache or updating to the latest version.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section className="scroll-mt-16" id="contact">
                        <h2 className="text-lg sm:text-2xl font-bold text-purple-800 mb-2 sm:mb-4">Contact Support</h2>
                        <div className="bg-purple-50 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-purple-100">
                            <div className="space-y-3">
                                <a
