...
export function setRefreshTokenInLocalStorage(accessToken) {
  if (accessToken !== undefined && accessToken !== null) {
    localStorage.setItem("COMICCOIN_FAUCET_TOKEN_UTILITY_REFRESH_TOKEN_DATA", accessToken);
  } else {
...
export function getRefreshTokenFromLocalStorage() {
  return localStorage.getItem("COMICCOIN_FAUCET_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
