...
export const COMICCOIN_FAUCET_PERCENTAGE_GRADE_WITH_EMPTY_OPTIONS = [
  { value: 0, label: "Please select" }, // EMPTY OPTION
  { value: 5, label: "5%" },
  { value: 10, label: "10%" },
  { value: 15, label: "15%" },
...
export const COMICCOIN_FAUCET_PERCENTAGE_GRADE_OPTIONS = [
  { value: 5, label: "5%" },
  { value: 10, label: "10%" },
  { value: 15, label: "15%" },
  { value: 20, label: "20%" },
...
export const HOW_DID_YOU_HEAR_ABOUT_US_OPTIONS = [
  ...
  { value: 3, label: "COMICCOIN_FAUCET website" },
...
export const SERVICE_TYPE_OPTIONS = [
  ...
  { value: 2, label: "COMICCOIN_FAUCET Pedigree Service" },
  { value: 3, label: "COMICCOIN_FAUCET Capsule" },
  { value: 4, label: "COMICCOIN_FAUCET Capsule Indie Mint Gem" },
  { value: 5, label: "COMICCOIN_FAUCET Capsule Signature Collection" },
  { value: 6, label: "COMICCOIN_FAUCET Capsule U-Grade" },
  { value: 7, label: "COMICCOIN_FAUCET Capsule U-Grade Signature Collection" },
];
