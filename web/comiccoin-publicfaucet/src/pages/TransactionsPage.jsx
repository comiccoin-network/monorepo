...
const TransactionsPageContent = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
        <AppTopNavigation />
        <div className="flex-grow bg-gradient-to-b from-purple-50 to-white py-8 flex flex-col items-center justify-center px-4">
...
// Wrap the component with both auth HOC and wallet HOC to match the TypeScript version
