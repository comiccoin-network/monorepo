// monorepo/web/comiccoin-publicfaucet/src/pages/AuthCallbackPage.tsx
    ...
    useEffect(() => {
        ...
        async function handleAuth() {
            ...
            try {
                ...
                if (!federatedidentityID) throw new Error('Missing federated identity ID')
...
const AuthCallbackLoading: React.FC = () => {
    return (
        <div className="flex min-h-screen items-center justify-center">
            <div className="relative">
                <div className="animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-blue-500" />
                <div className="absolute -bottom-8 left-0 right-0 text-center text-sm text-gray-600">Loading...</div>
            </div>
        </div>
    )
}
