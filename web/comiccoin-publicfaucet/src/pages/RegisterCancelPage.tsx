// monorepo/web/comiccoin-publicfaucet/src/pages/RegisterCancelPage.tsx
                ...
                <div className="text-center px-4 max-w-lg">
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-3xl font-semibold text-gray-900">Registration Canceled</h1>
                            <p className="text-gray-600 text-lg">
                                Your registration process has been canceled. You can return to the homepage or start a
                                new registration whenever you're ready.
                            </p>
                        </div>
                        ...
                        <p className="text-sm text-gray-500 mt-6">
                            ...
                            <a href="mailto:hello@comiccoin.com" className="text-purple-600 hover:underline">
                                hello@comiccoin.com
                            </a>
                        </p>
                    </div>
