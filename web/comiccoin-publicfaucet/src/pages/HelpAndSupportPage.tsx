// monorepo/web/comiccoin-publicfaucet/src/pages/HelpAndSupportPage.tsx
import { useState } from 'react'
import { HelpCircle, Mail, ChevronDown, ChevronUp, Search, Book, Globe, Github } from 'lucide-react'
    ...
    const faqs: FAQ[] = [
        {
            ...
            answer: 'ComicCoin is a blockchain designed specifically for comic book enthusiasts and collectors.',
        },
        {
            question: 'How often can I claim free coins?',
            answer: "You can claim free ComicCoins from the faucet once every 24 hours. After claiming, you'll need to wait until the next day to claim again.",
        },
        {
            question: 'How do I connect my wallet?',
            answer: "To connect your wallet, you will need to create a wallet via <a href='https://comiccoinwallet.com' target='_blank' rel='noopener noreferrer' class='text-purple-600 hover:text-purple-800 underline'>one of the wallets</a>. You can view your wallet address and balance on the 'My Wallet' page.",
        },
        {
            question: 'What can I do with my ComicCoins?',
            answer: 'You can use ComicCoins to purchase digital comics, invest in comic book projects, participate in exclusive auctions, and trade with other collectors on the ComicCoin marketplace.',
        },
        {
            question: 'Is there a mobile app available?',
            answer: "You can download them <a href='https://comiccoinwallet.com' target='_blank' rel='noopener noreferrer' class='text-purple-600 hover:text-purple-800 underline'>here</a>.",
        },
        {
            question: 'How secure is the ComicCoin platform?',
            answer: 'ComicCoin uses blockchain technology to ensure secure transactions and storage of your coins. We also implement industry-standard security practices to protect your account and personal information.',
        },
        {
            question: 'Can I transfer ComicCoins to another wallet?',
            answer: 'Yes, you can transfer your ComicCoins to other wallets within the ComicCoin network. Go to your wallet on your mobile device or desktop wallet and use the transfer function to send coins to another address.',
        },
    ]
...
export default withAuth(HelpAndSupportPage)
