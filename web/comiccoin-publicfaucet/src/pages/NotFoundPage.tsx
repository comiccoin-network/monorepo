// monorepo/web/comiccoin-publicfaucet/src/pages/NotFoundPage.tsx
            ...
            <div className="text-center max-w-md">
                ...
                <div className="mb-8 flex justify-center">
                    <div className="relative">
                        <AlertCircle className="h-24 w-24 text-purple-500 animate-pulse" aria-label="Page Not Found" />
                ...
                <p className="text-sm text-gray-500 mt-8">
                    ...
                    <a href="mailto:support@comiccoin.com" className="text-purple-600 hover:underline ml-1">
                        Contact Support
                    </a>
                </p>
            </div>
