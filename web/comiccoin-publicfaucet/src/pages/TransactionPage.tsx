...
import { Coins, ArrowLeft, ChevronDown, ChevronUp, ExternalLink, RefreshCw, Filter } from "lucide-react";
...
const TransactionsPageContent: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white py-8 flex flex-col items-center justify-center" role="status">
        <div className="animate-pulse">
          <Coins className="h-16 w-16 text-purple-400 mb-4" aria-hidden="true" />
        </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white py-8 flex flex-col items-center justify-center px-4">
        <div className="text-center max-w-md">
          <div className="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-full bg-red-100" aria-hidden="true">
          ...
          <p className="text-base text-gray-600 mb-6">
            {error.message || "Failed to load transactions. Please check your connection and try again."}
          </p>
          <button
            onClick={() => refetch()}
  ...
  return (
    ...
    >
            ...
            <div className="flex items-center bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
              <button
                ...
                className={`px-3 py-2 flex items-center text-sm focus:outline-none focus:bg-purple-50 ${
                  sortBy.field === "timestamp" ? "text-purple-700 font-medium bg-purple-50" : "text-gray-700 hover:bg-gray-50"
                }`}
              ...
              <div className="h-6 border-r border-gray-200" aria-hidden="true"></div>
              <button
                onClick={() => handleSort("amount")}
                className={`px-3 py-2 flex items-center text-sm focus:outline-none focus:bg-purple-50 ${
                  sortBy.field === "amount" ? "text-purple-700 font-medium bg-purple-50" : "text-gray-700 hover:bg-gray-50"
                }`}
      ...
      <div className="space-y-4">
        {(!sortedTransactions || sortedTransactions.length === 0) ? (
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
            <ul className="divide-y divide-gray-200" role="list" aria-label="Transaction list">
      ...
      <button
        ...
        style={{
          display: 'none',
          /* Script will make this visible when scrolled - add this in a separate script tag:
