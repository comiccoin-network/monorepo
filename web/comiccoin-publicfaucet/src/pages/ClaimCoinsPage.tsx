...
const ClaimCoinsPage: React.FC<ClaimCoinsPageProps> = () => {
  ...
  const handleClaimCoins = async () => {
    ...
    try {
      ...
      // Redirect to dashboard after a short delay to show confetti
      setTimeout(() => {
      ...
      <div className="max-w-md mx-auto space-y-6">
        ...
        {errorMessage && (
          ...
          >
            ...
            <div>
              <h3 id="error-heading" className="text-sm font-medium text-red-800">Claim failed</h3>
          ...
          {claimSuccess ? (
            ...
            <>
              ...
              >
                ...
                <div className="absolute bottom-3 right-3 text-yellow-400 opacity-70" aria-hidden="true">
                  <Star size={16} fill="currentColor" />
                </div>
                ...
                >
                  ...
                  <div>
                    <div
                      ...
                      style={!isFaucetLoading ? { animation: "pulse 3s ease-in-out infinite" } : {}}
                      aria-live="polite"
                    >
                      {isFaucetLoading ? (
        ...
        >
          ...
          <p className="text-sm text-gray-600 leading-relaxed pl-9">
            ...
            purchase special editions, or trade with other collectors. Check your total balance on the dashboard.
          </p>
        </Card>
      </div>
    </div>
