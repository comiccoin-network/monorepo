// monorepo/web/comiccoin-publicfaucet/src/pages/PrivacyPage.tsx
                ...
                <div className="max-w-4xl mx-auto px-4 py-12">
                    <div className="bg-white rounded-xl p-8 shadow-lg mb-8">
                        ...
                        <div className="prose prose-purple max-w-none">
                            ...
                            <p className="text-gray-700 mb-6">ComicCoin Network - ComicCoin Faucet</p>
                            ...
                            <p className="text-gray-700 mb-4">
                                This site is not intended to serve customers outside of Canada. If you leave a comment,
                                review or interaction on our site you may opt-in to saving your name, email address and
                            ...
                            <p className="text-gray-700 mb-6">
                                ...
                                concerns about your personal data and its use, we encourage you to use our services
                                offline instead.
                            </p>
                            ...
                            <p className="text-gray-700 mb-6">
                                If you have any questions or need help, simply email support@comiccoin.network and we
