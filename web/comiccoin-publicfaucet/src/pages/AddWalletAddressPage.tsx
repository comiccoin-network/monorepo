...
const ConfirmationModal = ({ isOpen, onClose, onConfirm, walletAddress }: ConfirmationModalProps) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl max-w-md w-full p-4 sm:p-6 relative">
                ...
                <div className="mb-4 sm:mb-6 text-center">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 mb-1 sm:mb-2">Confirm Your Wallet</h3>
                    <p className="text-sm text-gray-600">Please verify that this is your correct wallet address:</p>
                </div>

                <div className="bg-purple-50 p-3 sm:p-4 rounded-lg mb-4 sm:mb-6">
                    <p className="font-mono text-sm text-purple-800 break-all">{walletAddress}</p>
                </div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <div>
                            <p className="text-sm text-yellow-800">
                                Double-check your wallet address carefully. Coins sent to the wrong address cannot be
                                recovered!
                            </p>
                        </div>
                    </div>
...
function AddWalletAddressPage() {
    ...
    const { user, updateUser, isLoading, error: userError } = useMe()

    const { connectWallet, isConnecting, error: connectError } = useWalletConnect()
            ...
            <div className="w-full py-4 px-3 sm:p-4">
                <div className="max-w-2xl w-full mx-auto space-y-4 sm:space-y-6">
                    ...
                    <div className="bg-white rounded-xl p-4 sm:p-6 border-2 border-purple-200 text-center">
                        <h2 className="text-base sm:text-lg font-semibold text-purple-800 mb-2">Setup Progress</h2>
                        ...
                        <div className="mt-2 text-xs sm:text-sm text-gray-600">Step 2 of 3: Connect Wallet</div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 border-2 border-purple-200">
                                ...
                                <div className="grid gap-3 sm:gap-4">
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-medium text-sm sm:text-base">Web Wallet</div>
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-medium text-sm sm:text-base">Mobile App</div>
                                                <div className="text-xs sm:text-sm text-gray-500">
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-medium text-sm sm:text-base">Desktop Wallet</div>
                                                <div className="text-xs sm:text-sm text-gray-500">
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
                            <div className="flex gap-2">
                                <AlertTriangle className="h-5 w-5 text-yellow-600 flex-shrink-0 mt-0.5" />
                                <div>
                                    <h3 className="font-medium text-yellow-800 mb-1 text-sm sm:text-base">Important</h3>
                                    <p className="text-xs sm:text-sm text-yellow-800">
                                        Make sure to enter your wallet address correctly. If you enter the wrong
                                        address, your ComicCoins will be sent to someone else and cannot be recovered!
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={isConnecting || !walletAddress.match(/^0x[a-fA-F0-9]{40}$/)}
