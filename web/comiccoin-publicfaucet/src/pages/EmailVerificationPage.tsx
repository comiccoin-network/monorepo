...
import { useEmailVerification } from '../hooks/useEmailVerification' // Adjust import path as needed
...
const EmailVerification: React.FC = () => {
    ...
    useEffect(() => {
        if (verificationCode) {
            ...
            // Redirect or show error if no verification code
            navigate('/')
        }
                        ...
                        <div className="flex flex-col items-center space-y-6">
                            ...
                            <div className="text-center space-y-4">
                                <p className="text-gray-700">
                                    Thank you for verifying your email address. You can now access all features of
                                    ComicCoin Faucet.
                                </p>
