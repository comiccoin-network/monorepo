        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="bg-white rounded-xl p-8 shadow-lg mb-8">
            ...
            <div className="prose prose-purple max-w-none">
              ...
              <p className="text-gray-700 mb-4">
                ComicCoin Network will not be held responsible for any damages incurred through the use of our service.
                All ComicCoin distributions are determined by our automated system and are final.
              </p>

              <h2 className="text-2xl font-bold text-purple-800 mt-8 mb-4">Claiming Coins</h2>
              <p className="text-gray-700 mb-4">
                Users may claim coins from the faucet once every 24 hours. The exact amount may vary based on faucet balance
                and network conditions. ComicCoin Network reserves the right to modify distribution rates and amounts at any time.
              </p>

              <p className="text-gray-700 mb-4">
                Users must provide a valid wallet address to receive coins. ComicCoin Network is not responsible for coins sent
                to incorrect addresses due to user error.
              </p>

              <p className="text-gray-700 mb-4">
                Any attempt to circumvent the 24-hour claim limit through the use of multiple accounts, VPNs, or other methods
                is strictly prohibited and may result in permanent ban from the service.
              </p>

              <h2 className="text-2xl font-bold text-purple-800 mt-8 mb-4">OVERVIEW</h2>
              <p className="text-gray-700 mb-4">
                This website is operated by ComicCoin Network. Throughout the site, the terms "we", "us" and "our" refer
                to ComicCoin Network. We offer this website, including all information, tools
              ...
              <p className="text-gray-700 mb-4">
                By visiting our site and/or using our services, you
              ...
              <p className="text-gray-700 mb-4">
                ...
                misappropriation of your account. ComicCoin Network and its associates reserve
              ...
              <p className="text-gray-700 mb-4">
                Your use of any ComicCoin Network website is subject to our Privacy Policy.
              ...
              <p className="text-gray-700 mb-4">
                ...
                information about your usage and profile, which could
                include personally identifiable information. By using this site,
                you absolve us of any and all damages related to data breaches or leaks.
              </p>
              ...
              <p className="text-gray-700 mb-4">
                In no case shall ComicCoin Network, our directors, officers, employees,
                ...
                advised of their possibility, including data breach.
              </p>
              ...
              <p className="text-gray-700 mb-4">
                ...
                through arbitration, and aggregated damages will be limited to the value of service you received.
                All disputes shall be governed by and construed in
                accordance with the laws where ComicCoin Network operates.
              </p>

              <h2 className="text-2xl font-bold text-purple-800 mt-8 mb-4">Changes to Terms of Service</h2>
              <p className="text-gray-700 mb-4">
      ...
      <footer className="bg-gradient-to-r from-purple-700 to-indigo-800 text-white py-6">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-purple-200">
            © {new Date().getFullYear()} ComicCoin Network. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
