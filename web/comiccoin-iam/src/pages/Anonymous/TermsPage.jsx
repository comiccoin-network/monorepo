        ...
        <div className="bg-white rounded-xl p-8 shadow-md mb-8">
          <div className="flex items-center gap-3 mb-8 text-purple-700">
            ...
            <h2 className="text-2xl font-bold">
              ComicCoin Digital Identity Terms
            </h2>
          </div>

          <div className="prose prose-purple max-w-none">
            <h2 className="text-2xl font-bold text-purple-800 mt-8 mb-4">
              For ComicCoin Digital Identity
            </h2>
            <p className="text-gray-700 mb-4">
              ComicCoin Network provides a faucet service that allows users to
              claim free ComicCoins. By using this service, you agree to the
              following terms and conditions.
            </p>

            <p className="text-gray-700 mb-4">
              ComicCoin Network will not be held responsible for any damages
              incurred through the use of our service. All ComicCoin
              distributions are determined by our automated system and are
              final.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Users may claim coins from the faucet once every 24 hours. The
              exact amount may vary based on faucet balance and network
              conditions. ComicCoin Network reserves the right to modify
              distribution rates and amounts at any time.
            </p>

            <p className="text-gray-700 mb-4">
              Users must provide a valid wallet address to receive coins.
              ComicCoin Network is not responsible for coins sent to incorrect
              addresses due to user error.
            </p>

            <p className="text-gray-700 mb-4">
              Any attempt to circumvent the 24-hour claim limit through the use
              of multiple accounts, VPNs, or other methods is strictly
              prohibited and may result in permanent ban from the service.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              This website is operated by ComicCoin Network. Throughout the
              site, the terms "we", "us" and "our" refer to ComicCoin Network.
            ...
            <p className="text-gray-700 mb-4">
              By visiting our site and/or using our services, you engage in our
            ...
            <p className="text-gray-700 mb-4">
              ...
              misappropriation of your account. ComicCoin Network and its
            ...
            <p className="text-gray-700 mb-4">
              Your use of any ComicCoin Network website is subject to our
            ...
            <p className="text-gray-700 mb-4">
              ...
              information about your usage and profile, which could include
              personally identifiable information. By using this site, you
              absolve us of any and all damages related to data breaches or
              leaks.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              In no case shall ComicCoin Network, our directors, officers,
            ...
            <p className="text-gray-700 mb-4">
              ...
              through arbitration, and aggregated damages will be limited to the
              value of service you received. All disputes shall be governed by
              and construed in accordance with the laws where ComicCoin Network
              operates.
            </p>
