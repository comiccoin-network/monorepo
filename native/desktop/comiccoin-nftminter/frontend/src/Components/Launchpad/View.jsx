            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-2xl shadow-xl text-white p-8 mb-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold mb-4">Welcome to NFT Minting Wizard</h1>
                            <p className="text-lg opacity-90">Ready to create your NFT? This wizard will guide you through the process of minting your digital assets on the blockchain.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-100 rounded-xl">
                                ...
                                <div className="text-sm text-amber-800">
                                    ...
                                    <p>All NFT assets will be permanently published on the blockchain and will be publicly visible. Please ensure you've selected the correct assets before proceeding, as this action cannot be undone.</p>
                                </div>
                            </div>
