...
import { Wallet, AlertCircle, XCircle, ChevronRight, CheckCircle2 } from 'lucide-react';
                        ...
                        <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-purple-100 rounded-xl">
                                    <Wallet className="w-5 h-5 text-purple-600" aria-hidden="true" />
                                </div>
                                <h2 className="text-xl font-bold text-gray-900">Select Destination Wallet</h2>
                            </div>
                        </div>
                        <p className="text-sm text-gray-500">
                            Please enter the ComicCoin wallet address where the minted NFT will be sent.
                            This must be a valid ComicCoin wallet address provided by the customer.
                        </p>
                    </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-100 rounded-xl">
                                ...
                                <div className="text-sm text-amber-800">
                                    ...
                                    <p>
                                        Make sure the provided wallet address is a valid ComicCoin wallet.
                                        NFTs can only be minted to ComicCoin wallets. Other wallet types
                                        are not supported and will cause the minting process to fail.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg max-w-md w-full mx-4">
                            <div className="p-6">
                                ...
                                <p className="text-sm text-gray-500 mb-6">
                                    Are you sure you want to abandon the minting process? All progress will be lost and you'll need to start over.
                                </p>
