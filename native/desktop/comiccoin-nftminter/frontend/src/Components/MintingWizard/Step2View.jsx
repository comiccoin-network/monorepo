                ...
                <div className="bg-white rounded-xl border-2 border-gray-100">
                        ...
                        <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-purple-100 rounded-xl">
                                    <Upload className="w-5 h-5 text-purple-600" aria-hidden="true" />
                                </div>
                                <h2 className="text-xl font-bold text-gray-900">Upload NFT Assets</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Animation Upload */}
                            <div className="space-y-2">
                                <span className="text-sm font-medium text-gray-700">Animation File</span>
                                <div className="flex gap-2">
                                    <input
                                        type="text"
                                        value={animation}
                                        ...
                                        className={`flex-grow px-4 py-3 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${
                                            errors.animation ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                        }`}
                            ...
                            {/* External URL */}
                            <label className="block">
                                <span className="text-sm font-medium text-gray-700">External URL</span>
                                <input
                                    type="url"
                                    value={externalURL}
