          ...
          <div className="container mx-auto px-4 py-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              {token.metadata.animation_url &&
               token.metadata.animation_url !== "ipfs://" &&
               token.metadata.animation_url !== "https://" ? (
                ...
                <div className="text-center p-8 bg-gray-50 rounded-lg">
                  <p className="text-gray-500">No animation content available for this NFT</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              {token.metadata.youtube_url ? (
                ...
                <div className="text-center p-8 bg-gray-50 rounded-lg">
                  <p className="text-gray-500">No YouTube content available for this NFT</p>
                </div>
              )}
            </div>
